...
export class OtpService {
	...
	async generateOtp({
		...
		const expiry: OtpExpiryDuration = {
			days: 0,
			hours: 0,
			minutes: 5,
			seconds: 0,
	 ...
	 *
	 * @param {OtpExpiryDuration} duration - The duration object containing days, hours, minutes, and seconds.
	...
	private async _generateExpiration({
		...
		minutes = 0,
		seconds = 0,
	}: OtpExpiryDuration): Promise<Date> {
