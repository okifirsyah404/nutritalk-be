...
export class PatientAccountResponse implements IAccountEntity {
	...
	public static fromEntity(account: IAccountEntity): PatientAccountResponse {
		return new PatientAccountResponse(account);
	}
}
